...
export const invitation = (prop, path) => html`
  <section id="landing">
    <h1 class="heading _background-cloud">Свето кръщение<br /><span>Емил</span></h1>
  </section>
  <section id="invitation">
    <div class="content _background-cloud">
  ...
  <section id="program">
    <article class="_background-cloud">
  ...
  <section id="location">
    ...
    <div class="map-container _background-cloud">
